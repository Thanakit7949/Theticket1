import { Box, Card, Typography, Button, CardMedia, Paper, Grid } from '@mui/material';
      ...
      <Button
        ...
        sx={{
          ...
          '&:hover': {
            ...
            animation: 'shake 0.5s ease-in-out', // สั่นเมื่อ hover
          },
        }}
      >
        Concert
                    ...
                    {dataconcerts.map((concert) => (
                        ...
                        >
                            ...
                            <Button
                                ...
                                variant="contained"
                                color="secondary"
                                sx={{ mt: 'auto', bgcolor: '#FF6699', '&:hover': { bgcolor: 'black' } }}
                            >
                                Book Now
                            </Button>
                        </Card>
...
>
  ...
  <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 4 }}>
    ...
    >
      ...
      <Typography variant="body1" paragraph>
        Details about the first sports event. Discover more about it and dive into the experience.
      </Typography>
    </Paper>
  </Box>
  ...
  <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 8 }}>
    ...
    >
      ...
      <Typography variant="body1" paragraph>
        Learn about the second exciting sports event that will take place. Find out more about the event.
      </Typography>
    </Paper>
    ...
    >
      ...
      <Typography variant="body1" paragraph>
        Get ready for the third major sports event. This is one you don’t want to miss!
      </Typography>
    </Paper>
  </Box>
...
<Box sx={{ position: 'relative', textAlign: 'center', mb: 5 }}>
  ...
  <Grid item xs={12} sm={6} lg={4}>
    ...
    >
      <Box sx={{ height: 192, bgcolor: '#e0f7fa', borderRadius: 2, mb: 2, overflow: 'hidden' }}>
        <img src={pur} alt="Product 1" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
      </Box>
      <Typography variant="h6" gutterBottom sx={{ fontWeight: 'bold', color: '#4A4A4A' }}>
        Product 1
      </Typography>
      <Typography variant="body2" color="textSecondary" gutterBottom>
        This is a premium product offering high quality and excellent performance.
      </Typography>
  ...
  <Grid item xs={12} sm={6} lg={4}>
    ...
    >
      <Box sx={{ height: 192, bgcolor: '#e0f7fa', borderRadius: 2, mb: 2, overflow: 'hidden' }}>
        <img src={toy} alt="Product 2" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
      </Box>
      <Typography variant="h6" gutterBottom sx={{ fontWeight: 'bold', color: '#4A4A4A' }}>
        Product 2
      </Typography>
      <Typography variant="body2" color="textSecondary" gutterBottom>
        Experience the best with our top-rated product that guarantees satisfaction.
      </Typography>
      <Button fullWidth variant="contained"
        sx={{
          bgcolor: '#ffccbc',
  ...
  <Grid item xs={12} sm={6} lg={4}>
    ...
    >
      <Box sx={{ height: 192, bgcolor: '#e0f7fa', borderRadius: 2, mb: 2, overflow: 'hidden' }}>
        <img src={molly} alt="Product 3" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
      </Box>
      <Typography variant="h6" gutterBottom sx={{ fontWeight: 'bold', color: '#4A4A4A' }}>
        Product 3
      </Typography>
      <Typography variant="body2" color="textSecondary" gutterBottom>
        Crafted to perfection, this product provides durability and superior quality.
      </Typography>
      <Button fullWidth variant="contained" 
        sx={{
          bgcolor: '#ffccbc',
  ...
  <Grid item xs={12} sm={6} lg={4}>
    ...
    >
      <Box sx={{ height: 192, bgcolor: '#e0f7fa', borderRadius: 2, mb: 2, overflow: 'hidden' }}>
        <img src={labubu} alt="Product 4" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
      </Box>
      <Typography variant="h6" gutterBottom sx={{ fontWeight: 'bold', color: '#4A4A4A' }}>
        Product 4
      </Typography>
  ...
  <Grid item xs={12} sm={6} lg={4}>
    ...
    >
      <Box sx={{ height: 192, bgcolor: '#e0f7fa', borderRadius: 2, mb: 2, overflow: 'hidden' }}>
        <img src={bbrick} alt="Product 5" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
      </Box>
      <Typography variant="h6" gutterBottom sx={{ fontWeight: 'bold', color: '#4A4A4A' }}>
        Product 5
      </Typography>
  ...
  <Grid item xs={12} sm={6} lg={4}>
    ...
    >
      <Box sx={{ height: 192, bgcolor: '#e0f7fa', borderRadius: 2, mb: 2, overflow: 'hidden' }}>
        <img src={pop} alt="Product 6" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
      </Box>
      <Typography variant="h6" gutterBottom sx={{ fontWeight: 'bold', color: '#4A4A4A' }}>
        Product 6
      </Typography>
